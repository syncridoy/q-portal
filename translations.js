...
export const TRANSLATIONS = {
  en: {
    ...
    "th_bal": "Bal",
    "th_ser": "Ser",
    "th_avg_exp_monthly": "avg Exp (Monthly)",
    "th_days_last": "How long will this Bal last",
    "th_dmd_qty": "DMD Qty",
    "th_view_ref_ltr": "View Ref Ltr",
    "th_bal_aq_br": "Bal of AQ Br",
    "th_alt_qty": "Alt Qty",
    "th_att_ref_ltr": "Att Ref Ltr",
    "btn_dmd_bde_hq": "DMD for Bde HQ",
    "btn_unit_demands": "Unit Demands",
    "th_course": "Course",
    "th_held": "Held",
  ...
  bn: {
    ...
    "th_bal": "মজুদ",
    "th_ser": "ক্রমিক",
    "th_avg_exp_monthly": "গড় খরচ (মাসিক)",
    "th_days_last": "মজুদ হতে চলবে (দিন)",
    "th_dmd_qty": "চাহিদার পরিমাণ",
    "th_view_ref_ltr": "চাহিদা চিঠি",
    "th_bal_aq_br": "একিউ শাখার মজুদ",
    "th_alt_qty": "বরাদ্দ পরিমাণ",
    "th_att_ref_ltr": "চিঠি সংযুক্ত করুন",
    "btn_dmd_bde_hq": "ব্রিগেড সদরের চাহিদা",
    "btn_unit_demands": "ইউনিটসমূহের চাহিদা",
    "th_course": "কোর্স",
    "th_held": "প্রাপ্ত",
